//订阅者回调签名
import 'eventBusType.dart';

typedef void SPEventCallback(dynamic arg);
...
class SPEventBus {
  ...
  //保存单例
  static SPEventBus _singleton = SPEventBus._internal();

  //工厂构造函数
  factory SPEventBus() => _singleton;

  //保存事件订阅者队列，key:事件名(id)，value: 对应事件的订阅者队列
  final _emap = Map<SPEventBusType, List<SPEventCallback>?>();

...
class _ChatBubbleState extends State<ChatBubble> {
  ...
  Widget build(BuildContext context) {
    return SPScaffold(
      title: const Text('Test ChatBubble'),
      body: Column(
        ...
        children: [
          Container(
            child: const Bubble(
                child: Text('hi?'), direction: BubbleDirection.left),
            margin: const EdgeInsets.all(15),
          ),
          Container(
            child: const Bubble(
                child: Text(
                    'I am fine I am fine I am fine I am fine I am fine I am fine I am fine I am fine'),
...
class Bubble extends StatelessWidget {
  ...
  const Bubble(
      {Key? key, this.direction = BubbleDirection.left, required this.child})
      : super(key: key);
